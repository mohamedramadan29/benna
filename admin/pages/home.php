...
if (isset($_POST['add_pro'])) {
  ...
  if (empty($formerror)) {
    ...
    $stmt->execute(array(
        $banner_head,$banner_desc,$about_head,$about_description,$category_head
    )); 
     if (!empty($_FILES['banner_image']['name']) && !empty($_FILES['about_image']['name'])) {
                $stmt = $connect->prepare("UPDATE home_page SET banner_image=?, about_image=?");
                $stmt->execute(array(
                    $banner_image_uploaded, $about_image_uploaded
                ));
            }
             if (!empty($_FILES['banner_image']['name'])) {
    ...
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            <div class="form-group">
                ...
                <textarea style='height:60px' id="description" name="banner_desc" class="form-control" rows="4"><?php echo $banner_desc   ?></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            ...
            <div class="form-group">
                ...
                <input required type="text" id="category_head" name="category_head" class="form-control" value="<?php  echo $category_head ?>">
            </div>
            </div>
            <!-- /.card-body -->
          </div>
