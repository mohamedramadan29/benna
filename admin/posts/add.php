...
if (isset($_POST['add_cat'])) {
    ...
    if (empty($formerror)) {
        $stmt = $connect->prepare("INSERT INTO posts (cat_id,name,slug,main_image,short_desc,description,date)
        VALUES (:zcat_id,:zname,:zslug,:zimage,:zshort_desc,:zdesc,:zdate)");
        $stmt->execute(array(
            "zcat_id" => $cat_id,
            "zname" => $name,
            "zslug" => $slug,
