        ...
        <div class="container-fluid">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFile" accept='image/*'
                                            name="main_image" value="<?php if (isset($_REQUEST['main_image']))
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4">
                                    <div class="info">
                                        <h6> الرئيسية </h6>
                                        <a target='_blank' href="product_images/<?php echo $pro_data['main_image']; ?>"
                                        data-toggle="lightbox" data-title="sample 2 - black">
                                        <img style="max-width: 100%;"
                                            src="product_images/<?php echo $pro_data['main_image']; ?>"
                                ...
                                <div class="info">
                                    ...
                                    <div class="row">
                                        ...
                                        for ($i = 0; $i < $countfile; ++$i) { ?>
                                            ...
                                            <div class="col-3">
                                                <div class="">
                                                    <a target='_blank' href="product_images/<?= $images[$i] ?>"
                                                        data-toggle="lightbox" data-title="sample 2 - black">
                                                        <img style="max-width: 100%;" src="product_images/<?= $images[$i] ?>"
                ...
                <div class="row" style="display: flex;justify-content: space-between;">
                    <button type="submit" class="btn btn-primary" name="edit_pro"> <i class="fa fa-save"></i> حفظ التعديلات
                    </button>
                    <a href="main.php?dir=products&page=report" class="btn btn-secondary">رجوع <i
