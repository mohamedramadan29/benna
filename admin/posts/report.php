                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="main.php?dir=posts&page=delete&post_id=<?php echo $post['id']; ?>" class="confirm btn btn-danger btn-sm"> حذف <i class='fa fa-trash'></i> </a>
                                            </td>
                                        </tr>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="cat_id" class='form-control select2' id="" >
                                                                    ...
                                                                    {?>
                                                                        <option <?php if($post['cat_id'] == $cat['id']) echo 'selected'; ?> value="<?php echo $cat['id']; ?>">  <?php echo $cat['name']; ?> </option>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="summernote" style="height: 150px;" id="Company-2" name="description" class="form-control"><?php echo $post['description']; ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="main.php?dir=posts&page=add" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="Company-2" class="block"> الوصف </label>
                                        <textarea id="summernote" style="height: 150px;" id="Company-2" name="description" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="Company-2" class="block"> وصف مختصر  </label>
