                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <button type="button" class="btn btn-primary waves-effect btn-sm" data-toggle="modal"
                            data-target="#add-Modal"> أضافة مقال جديد <i class="fa fa-plus"></i> </button>
                    </div>
                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td> <img style="width: 60px; height:60px"
                                                        src="posts/images/<?php echo $post['main_image']; ?> " alt=""></td>
                                            <td>
                                                <button type="button" class="btn btn-success btn-sm waves-effect"
                                                    data-toggle="modal"
                                                    data-target="#edit-Modal_<?php echo $post['id']; ?>"> تعديل <i
                                                        class='fa fa-pen'></i> </button>
                                                <a href="main.php?dir=posts&page=delete&post_id=<?php echo $post['id']; ?>"
                                                    class="confirm btn btn-danger btn-sm"> حذف <i class='fa fa-trash'></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <!-- EDIT NEW CATEGORY MODAL   -->
                                        <div class="modal fade" id="edit-Modal_<?php echo $post['id']; ?>" tabindex="-1"
                                            role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="main.php?dir=posts&page=edit"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="summernote" style="height: 150px;"
                                                                    id="Company-2" name="description"
                                                                    class="form-control"><?php echo $post['description']; ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="Company-2" class="block"> وصف مختصر </label>
                                                                <textarea style="height: 70px;" id="Company-2"
                                                                    name="short_desc"
                                                                    class="form-control"><?php echo $post['short_desc']; ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="main.php?dir=posts&page=add" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="Company-2" class="block"> الوصف </label>
                                        <textarea class="summernote" style="height: 150px;" id="Company-2"
                                            name="description" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="Company-2" class="block"> وصف مختصر </label>
                                        <textarea style="height: 70px;" id="Company-2" name="short_desc"
